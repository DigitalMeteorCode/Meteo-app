...
const CLEFAPI = "b5aaa17b9ccf509bae7a09ff20a05bbf";
let resultatsAPI;
...
if (navigator.geolocation) {
  navigator.geolocation.getCurrentPosition(
    ...
    () => {
      alert(
        `Vous avez refusé la géolocalisation, l'application de peux pas fonctionner. Veuillez l'activer.`
      );
    }
  );
}
...
function AppelAPI(long, lat) {
  fetch(
    ...
    .then((data) => {
      ...
      //icone dynamique
      if(resultatsAPI.current.weather[0].icon[2]==='d') {
